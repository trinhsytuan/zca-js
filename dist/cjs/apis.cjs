...
var getMultiUsersByPhone = require('./apis/getMultiUsersByPhone.cjs');
...
var getSearchSticker = require('./apis/getSearchSticker.cjs');
...
var updateStatus = require('./apis/updateStatus.cjs');
var upgradeGroupCommunity = require('./apis/upgradeGroupCommunity.cjs');
...
class API {
    constructor(ctx, zpwServiceMap, wsUrls) {
        ...
        this.getMultiUsersByPhone = getMultiUsersByPhone.getMultiUsersByPhoneFactory(ctx, this);
        ...
        this.getSearchSticker = getSearchSticker.getSearchStickerFactory(ctx, this);
        ...
        this.updateStatus = updateStatus.updateStatusFactory(ctx, this);
        this.upgradeGroupCommunity = upgradeGroupCommunity.upgradeGroupCommunityFactory(ctx, this);
